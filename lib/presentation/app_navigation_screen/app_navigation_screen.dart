                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 14 - Nine".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone14NineScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 14 - Ten".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone14TenScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 14 - Eleven".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone14ElevenScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "iPhone 14 - Twelve".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.iphone14TwelveScreen),
                        ),
                      ],
                    ),
                  ),
